...
DATABASES = {
    "default": {
        "NAME": "material_ui_plugin",  # Database name
        "USER": "plugin",  # Database username
        "PASSWORD": "password",  # Database password
        "HOST": "localhost",  # Database server
        "PORT": 54321,  # Database port (leave blank for default)
...
SECRET_KEY = os.getenv("NAUTOBOT_SECRET_KEY", "h_l25wj=cga7n6=$w@+6$3(fgxr*vk+ue0(m1i$ih@r!jy&tv&")
